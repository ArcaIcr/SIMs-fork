    ...
    <div className="min-h-screen bg-[#FFF7E6] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-start px-8 py-6 gap-8">
        ...
        <div className="flex gap-8 w-full max-w-4xl justify-center mt-4">
          <button className="flex-1 py-4 rounded-2xl bg-white shadow text-xl font-semibold text-[#B77B2B] border-2 border-[#E2C089] hover:bg-[#FFF0D2]" onClick={() => navigate('/dashboard/manager/inventory')}>Inventory</button>
