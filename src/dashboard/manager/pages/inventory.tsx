...
const InventoryPage = () => {
  ...
  const filteredItems = DUMMY_ITEMS.filter(item => item.category === selectedCategory);
          ...
          {filteredItems.map(item => (
            <div key={item.id} className="flex items-center justify-between bg-[#FFD59A] rounded-xl px-4 py-2 mb-2">
              ...
              <div className="flex items-center gap-2">
                <button className="bg-[#F9C97B] text-white rounded-full w-7 h-7 flex items-center justify-center text-lg font-bold">-</button>
