    ...
    <div className="flex items-center justify-between px-8 py-4 bg-[#FFF7E6] border-b-2 border-[#E2C089] shadow-md">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-xs text-[#8B6F3A]">Manager | {user?.branchName || 'Branch'}</div>
        </div>
      </div>
      <div className="flex gap-4">
        <button className="bg-white rounded-full shadow p-3"><i className="fa fa-user-plus text-[#B77B2B]"></i></button>
        <button className="bg-white rounded-full shadow p-3"><i className="fa fa-bell text-[#B77B2B]"></i></button>
        <button className="bg-white rounded-full shadow p-3"><i className="fa fa-cog text-[#B77B2B]"></i></button>
      </div>
    </div>
  );
};
