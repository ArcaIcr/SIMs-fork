      ...
      <div className="flex gap-4">
        ...
        {showNotifications && (
          <div className="absolute top-16 right-0 bg-white border border-[#E2C089] rounded-xl shadow-lg p-4 w-80 z-50">
            ...
            <div className="text-sm text-[#8B6F3A]">No new notifications.</div>
            <button className="mt-4 text-xs text-orange-500 hover:underline" onClick={() => setShowNotifications(false)}>Close</button>
          </div>
        )}
      </div>
    </div>
